...
\begin{quiz}[Why is speech input challenging for text mining in the
  clinical setting?]
  ~\\
...
\begin{quiz}[Why is IDF useful in the extraction of relevant keywords?]
  ~\\
  Because keywords that occur in fewer conversations are more relevant.
\end{quiz}

\begin{quiz}[What are the challenges of clinical text?]
  ~\\
